(define plambda_init_lsp
  (concat
   ...
   "\n"
   "(define b2 (apply mkdrone 'b2' (+ (* (int 2) (int {1})) (int 1)) (int 10) (int 10) (boolean false) (boolean false) 'log1.txt' ))"
   "\n"
   "(define b3 (apply mkdrone 'b3' (+ (* (int 2) (int {1})) (int 1)) (int 110) (int 110) (boolean false) (boolean false) 'log1.txt' ))"
   "\n"
   "(apply setStartTime)"
   "\n"
