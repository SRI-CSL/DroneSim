(define plambda_init_lsp
  (concat
   ...
   "\n"
   "(define b1 (apply mkdrone 'b1' (+ (* (int 2) (int {1})) (int 1)) (int 100) (int 100) (boolean false) (boolean false) 'log1.txt' ))"
   "\n"
   "(define b2 (apply mkdrone 'b2' (+ (* (int 2) (int {1})) (int 2)) (int 10) (int 10) (boolean false) (boolean false) 'log1.txt' ))"
   "\n"
   "(define b3 (apply mkdrone 'b3' (+ (* (int 2) (int {1})) (int 3)) (int 110) (int 110) (boolean false) (boolean false) 'log1.txt' ))"
   "\n"
   "(apply setStartTime)"
   "\n"
...
(define maude_init_maude
  (concat
   ...
   "loop init ."
   "\n"
   "(seq\n (initAgentEset maude{0} g2d g2d plambda{0} ANALYSIS asysLowWind20 false)\n (augAgentEsetConcurrentStats Patrol 400))"
   "\n"
   )
  )
